...
export const content = {
    pt: {
        ...
        'work.subtitle' : 'Esses são alguns dos meus trabalhos mais recentes.',
        'contact.title' : 'Contato',
        'contact.text'  : 'Quer saber mais sobre o meu trabalho ou falar comigo? Você pode me encontrar nas plataformas abaixo ou entrar em contato usando o formulário.',
        'contact.name'  : 'Nome',
    ...
    en: {
        ...
        'work.title'    : 'My work',
        'work.subtitle' : 'These are some of my most recent projects.',
        'contact.title' : 'Contact',
        'contact.text'  : 'Want to know more about my work or talk to me? You can find me on the platforms below or contact me using the contact form.',
        'contact.name'  : 'Name',
        'contact.email' : 'E-mail',
